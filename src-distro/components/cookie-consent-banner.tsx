...
export function CookieConsentBannerComponent() {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 bg-gray-100 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 p-4 md:flex md:items-center md:justify-between shadow-lg h-12"
      role="alert"
      aria-live="polite"
    >
      <div className="mb-4 md:mb-0 md:mr-4 flex-grow">
        <p className="text-sm text-gray-700 dark:text-gray-300">
          ...
          <a href="/content/privacy" className="text-primary hover:underline">
            Privacy Policy
          </a>
          .
        </p>
